...
### A little about me:
I am from latvia and I am very passionate about all things tech. In my free time I work on a various passion project including tech and event organization!
...
Trying to make it easier to do cool things together.<br>
\>[Mārtiņa-CTF](https://mctf.datoriki.org)<br>
Biggest team CTF in Latvia.

<b>Passion projects I am currently working on: </b><br>
\>[Faulty-Code-Studios](https://github.com/orgs/Faulty-Code-Studios)<br>
Working on a highly modular tower defense game. <em>Succesor to [M-TowerDefense](https://github.com/MuchMarts/M-TowerDefense)<em>.
<br>
\>[Afirmacijas.lv](https://github.com/orgs/Afirmacijas-lv)<br>
Updating a highschool project using Sveltkit. The greatest affirmation maker this side of milky way.
<br>
\>[Rendezvous](https://github.com/rendezvous-lv)<br>
